// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["ruyi", "bfzy", "tyyszy", "ffzy", "zy360", "wolong", "jisu", "dbzy", "mdzy", "zuid", "wujin"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["ruyi", "bfzy", "tyyszy", "ffzy", "zy360", "wolong", "jisu", "dbzy", "mdzy", "zuid", "wujin"];
